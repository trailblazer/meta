#!/usr/bin/env ruby
require 'git'
PACKAGES = { 'trailblazer' => ENV.fetch('TRAILBLAZER_ASSEMBLE_VERSION', 'master'),
             ...
             'trailblazer-operation' => ENV.fetch('TRAILBLAZER_OPERATION_ASSEMBLE_VERSION', 'master') }.freeze
